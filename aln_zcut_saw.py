...
def main():
    ...
    # AlN is fast; widen bounds
    v_short, err_short = solver.find_velocity(electric_bc="short", vmin=5000, vmax=7000)
    v_open, err_open = solver.find_velocity(electric_bc="open", vmin=5000, vmax=7000)
